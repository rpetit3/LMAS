class Help {
    ...
    static def print_help(Map params) {
        ...
        println ""
        println "    --illumina            Path expression to paired-end Illumina fastq files. (default: $params.illumina)"
        println ""
        println "    --nanopore            Path expression to ONT fastq files. (default: $params.nanopore)"
        println ""
